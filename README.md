...
**CI:** `.github/workflows/ci.yml` гоняет на каждый пуш валидатор паков, матрицу проб, референсный пайплайн и C#-эмулятор. **Бенчмарки:** `docs/benchmarks.md` (замеры без железа, не гарантии для устройства).
